...
$status=1;
$sql="INSERT INTO  tblblooddonars(FullName,MobileNumber,EmailId,Age,Gender,BloodGroup,Address,status) VALUES(:fullname,:mobile,:email,:age,:gender,:blodgroup,:address,:status)";
...
<div class="row">
<div class="col-lg-4 mb-4">
<div><input type="submit" name="submit" class="btn btn-primary" value="submit" onclick="show_alert();" style="cursor:pointer"></div>
</div>
